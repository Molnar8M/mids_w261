...
# START STUDENT CODE HW24REDUCER_MODEL
...
for k, [v0, v1] in wordcount.iteritems():
    ...
    fv1 = float(v1)
    # P(w|c = 0)
    pr0 = (fv0 + 1)/(cls_word_count[0] + v)
    # non-smoothing option: pr0 = fv0/cls_word_count[0]
    # P(w|c = 1)
    pr1 = (fv1 + 1)/(cls_word_count[1] + v)
    # non-smoothing options: pr1 = fv1/cls_word_count[1]
...
# END STUDENT CODE HW24REDUCER_MODEL 